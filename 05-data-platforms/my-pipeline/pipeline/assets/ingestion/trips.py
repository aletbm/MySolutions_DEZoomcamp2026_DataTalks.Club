...
#bruin validate my-pipeline/pipeline/pipeline.yml
#bruin run my-pipeline/pipeline/assets/staging/trips.sql --config-file "./my-pipeline/.bruin.yml" --start-date 2022-01-01 --end-date 2022-02-01